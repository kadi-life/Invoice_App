...
MIDDLEWARE = [
    ...
    'users.middleware.CacheControlMiddleware',  # Add cache control middleware
]
...
# Use the Neon database URL if in production, otherwise use SQLite for local development
DATABASES = {
